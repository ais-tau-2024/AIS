        ...
        <div class="container">
            <div class="card bg-white text-dark">
                <div class="header">
                    ...
                    <span
                        class="help-link"
                        :title="localization[langStore.lang]?.page?.auth?.helpTitle"
                    >
                        {{ localization[langStore.lang]?.page?.auth?.help }}
                    </span>
                </div>
                <h2 class="title">
                    {{ localization[langStore.lang]?.page?.auth?.title }}
                </h2>
                <form @submit.prevent="handleSubmit">
                    ...
                    <input
                        ...
                        :placeholder="localization[langStore.lang]?.page?.auth?.iinPlaceholder"
                    ...
                    <template v-if="step > 1">
                        ...
                        <input
                            ...
                            class="form-control w-100 mb-3"
                            :placeholder="
                                localization[langStore.lang]?.page?.auth?.passwordPlaceholder
                            "
