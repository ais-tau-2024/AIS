					...
					<div class="form-section">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" id="surname-translit" disabled v-model="data.lastName">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
							...
							<div class="input-group">
								...
								<input type="text" id="name-translit" disabled v-model="data.firstName">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
							...
							<div class="input-group">
								...
								<input type="text" id="patronymic-translit" disabled v-model="data.patronymic">
							</div>
						</div>
					</div>
				</div>
...
export default {
  ...
  async created() {
    ...
    if (me) {
      ...
      me.placeOfBirth = me.placeOfBirth ? { label: me.placeOfBirth } : null;
      me.registrationPlace = me.registrationPlace ? { label: me.registrationPlace } : null;
      me.residencePlace = me.residencePlace ? { label: me.residencePlace } : null;
      this.data = me;
